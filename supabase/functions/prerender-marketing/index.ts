...
const getPageContent = (locale: string, page: string): PageData | null => {
  ...
  const pages: Record<string, Record<string, PageData>> = {
    ...
    'product-hub': {
      en: { title: 'Product Overview – Quantifier GRC Platform', description: 'Explore Quantifier product modules: AI Compliance Officer, dashboards, document management, risk and value chain.', h1: 'Quantifier Product', subtitle: 'One AI-native platform for governance, risk and compliance.', sections: [{ h2: 'Modules', content: ['AI Compliance Officer', 'Task & data management', 'Analytics dashboards', 'Documents management', 'Risk assessment', 'Value chain'] }], internalLinks: [{ text: 'Product Overview', href: '/product/overview' }, { text: 'AI Compliance Officer', href: '/product/ai-compliance-officer' }, { text: 'Plans', href: '/plans' }] },
      pl: { title: 'Produkt – Platforma GRC Quantifier', description: 'Poznaj moduły Quantifier: AI Compliance Officer, dashboardy, zarządzanie dokumentami, ryzyko i łańcuch wartości.', h1: 'Produkt Quantifier', subtitle: 'Jedna platforma AI do zarządzania, ryzyka i zgodności.', sections: [{ h2: 'Moduły', content: ['AI Compliance Officer', 'Zadania i dane', 'Dashboardy analityczne', 'Zarządzanie dokumentami', 'Ocena ryzyka', 'Łańcuch wartości'] }], internalLinks: [{ text: 'Przegląd produktu', href: '/product/overview' }, { text: 'AI Compliance Officer', href: '/product/ai-compliance-officer' }, { text: 'Cennik', href: '/plans' }] },
      cs: { title: 'Produkt – GRC platforma Quantifier', description: 'Prozkoumejte moduly Quantifier: AI Compliance Officer, dashboardy, správa dokumentů, rizika a hodnotový řetězec.', h1: 'Produkt Quantifier', subtitle: 'Jedna AI platforma pro řízení, rizika a shodu.', sections: [{ h2: 'Moduly', content: ['AI Compliance Officer', 'Úkoly a data', 'Analytické dashboardy', 'Správa dokumentů', 'Hodnocení rizik', 'Hodnotový řetězec'] }], internalLinks: [{ text: 'Přehled produktu', href: '/product/overview' }, { text: 'AI Compliance Officer', href: '/product/ai-compliance-officer' }, { text: 'Ceník', href: '/plans' }] }
    },
    'epd': {
      en: { title: 'EPD Generator – Environmental Product Declarations', description: 'Generate ISO 14025 / EN 15804 compliant Environmental Product Declarations from your LCA data with Quantifier.', h1: 'EPD Generator', subtitle: 'Automate Type III Environmental Product Declarations end-to-end.', sections: [{ h2: 'What you get', content: ['EN 15804+A2 compliant EPDs', 'Linked LCA data and PCR rules', 'Verifier-ready report exports', 'Multi-product portfolio management'] }], internalLinks: [{ text: 'LCA Analysis', href: '/frameworks/product-level/lca-analysis' }, { text: 'Product-Level Compliance', href: '/frameworks/product-level' }, { text: 'Contact sales', href: '/contact' }] },
      pl: { title: 'Generator EPD – Deklaracje środowiskowe wyrobu', description: 'Twórz deklaracje EPD zgodne z ISO 14025 i EN 15804 na podstawie danych LCA w Quantifier.', h1: 'Generator EPD', subtitle: 'Zautomatyzuj deklaracje środowiskowe Typu III od początku do końca.', sections: [{ h2: 'Co otrzymujesz', content: ['EPD zgodne z EN 15804+A2', 'Dane LCA i reguły PCR', 'Raporty gotowe do weryfikacji', 'Zarządzanie wieloma produktami'] }], internalLinks: [{ text: 'Analiza LCA', href: '/frameworks/product-level/lca-analysis' }, { text: 'Compliance produktowe', href: '/frameworks/product-level' }, { text: 'Kontakt', href: '/contact' }] },
      cs: { title: 'Generátor EPD – Environmentální prohlášení', description: 'Vytvářejte EPD v souladu s ISO 14025 a EN 15804 z vašich LCA dat v Quantifier.', h1: 'Generátor EPD', subtitle: 'Automatizujte environmentální prohlášení o produktu typu III.', sections: [{ h2: 'Co získáte', content: ['EPD podle EN 15804+A2', 'Propojená LCA data a PCR pravidla', 'Reporty připravené k verifikaci', 'Správa portfolia produktů'] }], internalLinks: [{ text: 'LCA analýza', href: '/frameworks/product-level/lca-analysis' }, { text: 'Shoda na úrovni produktu', href: '/frameworks/product-level' }, { text: 'Kontakt', href: '/contact' }] }
    },
    'lca-analysis': {
      en: { title: 'LCA Analysis – Life Cycle Assessment Software', description: 'Run ISO 14040/14044 compliant Life Cycle Assessments with automated data collection, hotspot analysis and EPD-ready outputs.', h1: 'LCA Analysis', subtitle: 'Cradle-to-grave Life Cycle Assessment for products and portfolios.', sections: [{ h2: 'Capabilities', content: ['ISO 14040 / 14044 methodology', 'Cradle-to-grave and cradle-to-gate scopes', 'Hotspot and scenario analysis', 'EPD and DPP-ready data'] }], internalLinks: [{ text: 'EPD Generator', href: '/frameworks/product-level/epd' }, { text: 'Product-Level Compliance', href: '/frameworks/product-level' }, { text: 'Environmental frameworks', href: '/frameworks/environmental' }] },
      pl: { title: 'Analiza LCA – Ocena cyklu życia produktu', description: 'Wykonuj analizy LCA zgodne z ISO 14040/14044 z automatycznym zbieraniem danych i wynikami gotowymi do EPD.', h1: 'Analiza LCA', subtitle: 'Ocena cyklu życia produktu od kołyski do grobu.', sections: [{ h2: 'Możliwości', content: ['Metodyka ISO 14040 / 14044', 'Zakres cradle-to-grave i cradle-to-gate', 'Analiza hotspotów i scenariuszy', 'Dane gotowe do EPD i DPP'] }], internalLinks: [{ text: 'Generator EPD', href: '/frameworks/product-level/epd' }, { text: 'Compliance produktowe', href: '/frameworks/product-level' }, { text: 'Standardy środowiskowe', href: '/frameworks/environmental' }] },
      cs: { title: 'LCA analýza – Posouzení životního cyklu', description: 'Provádějte LCA podle ISO 14040/14044 s automatizovaným sběrem dat a výstupy připravenými pro EPD.', h1: 'LCA analýza', subtitle: 'Posouzení životního cyklu produktu od kolébky po hrob.', sections: [{ h2: 'Možnosti', content: ['Metodika ISO 14040 / 14044', 'Rozsah cradle-to-grave a cradle-to-gate', 'Analýza hotspotů a scénářů', 'Data připravená pro EPD a DPP'] }], internalLinks: [{ text: 'Generátor EPD', href: '/frameworks/product-level/epd' }, { text: 'Shoda na úrovni produktu', href: '/frameworks/product-level' }, { text: 'Environmentální standardy', href: '/frameworks/environmental' }] }
    },
    'events': {
      en: { title: 'Events & Webinars – Quantifier', description: 'Live and on-demand sessions on NIS2, ISO 27001, SOC 2 and AI-driven GRC. Join upcoming webinars or watch recordings.', h1: 'Events & Webinars', subtitle: 'Live and on-demand compliance sessions from Quantifier.', sections: [{ h2: 'What you can expect', content: ['Live webinars on NIS2, ISO 27001 and SOC 2', 'Workshops and round tables', 'On-demand recordings', 'Q&A with compliance experts'] }], internalLinks: [{ text: 'Blog', href: '/blog' }, { text: 'Cybersecurity Check', href: '/cybersecurity-check' }, { text: 'Contact sales', href: '/contact' }] },
      pl: { title: 'Wydarzenia i webinary – Quantifier', description: 'Webinary live i on-demand o NIS2, ISO 27001, SOC 2 i GRC z AI. Dołącz do nadchodzących sesji lub obejrzyj nagrania.', h1: 'Wydarzenia i webinary', subtitle: 'Webinary i wydarzenia compliance Quantifier — live i on-demand.', sections: [{ h2: 'Czego możesz się spodziewać', content: ['Webinary live o NIS2, ISO 27001 i SOC 2', 'Warsztaty i okrągłe stoły', 'Nagrania on-demand', 'Q&A z ekspertami compliance'] }], internalLinks: [{ text: 'Blog', href: '/blog' }, { text: 'Sprawdź cyberbezpieczeństwo', href: '/sprawdz-cyberbezpieczenstwo' }, { text: 'Kontakt', href: '/contact' }] },
      cs: { title: 'Akce a webináře – Quantifier', description: 'Živé i on-demand sezení o NIS2, ISO 27001, SOC 2 a GRC s AI. Připojte se k nadcházejícím webinářům.', h1: 'Akce a webináře', subtitle: 'Compliance webináře a akce Quantifier — živě i on-demand.', sections: [{ h2: 'Co můžete očekávat', content: ['Živé webináře o NIS2, ISO 27001 a SOC 2', 'Workshopy a kulaté stoly', 'Záznamy on-demand', 'Q&A s odborníky na compliance'] }], internalLinks: [{ text: 'Blog', href: '/blog' }, { text: 'Kybernetická prověrka', href: '/zkontrolujte-kybernetickou-bezpecnost' }, { text: 'Kontakt', href: '/contact' }] }
    },
    'event-nis2-in-poland': {
      en: { title: 'NIS2 in Poland – Webinar | Quantifier', description: 'Live webinar on NIS2 implementation in Poland: scope, KSC bill, sanctions and practical roadmap for in-scope entities.', h1: 'NIS2 in Poland — webinar', subtitle: 'NIS2 transposition status, scope and obligations under the Polish KSC act.', sections: [{ h2: 'Agenda', content: ['NIS2 scope: essential vs important entities', 'KSC act status and timeline in Poland', 'Sanctions and management liability', 'Practical compliance roadmap'] }], internalLinks: [{ text: 'NIS2 framework', href: '/frameworks/nis-2' }, { text: 'Cybersecurity Check', href: '/cybersecurity-check' }, { text: 'All events', href: '/events' }] },
      pl: { title: 'NIS2 w Polsce – Webinar | Quantifier', description: 'Webinar o wdrożeniu NIS2 w Polsce: zakres, ustawa KSC, kary i praktyczna mapa drogowa dla podmiotów objętych.', h1: 'NIS2 w Polsce — webinar', subtitle: 'Status transpozycji NIS2, zakres i obowiązki w świetle ustawy KSC.', sections: [{ h2: 'Agenda', content: ['Zakres NIS2: podmioty kluczowe i ważne', 'Status i harmonogram ustawy KSC w Polsce', 'Kary i odpowiedzialność zarządu', 'Praktyczna mapa drogowa zgodności'] }], internalLinks: [{ text: 'Standard NIS2', href: '/frameworks/nis-2' }, { text: 'Sprawdź cyberbezpieczeństwo', href: '/sprawdz-cyberbezpieczenstwo' }, { text: 'Wszystkie wydarzenia', href: '/events' }] },
      cs: { title: 'NIS2 v Polsku – Webinář | Quantifier', description: 'Webinář o implementaci NIS2 v Polsku: rozsah, zákon KSC, sankce a praktická roadmapa pro subjekty v rozsahu.', h1: 'NIS2 v Polsku — webinář', subtitle: 'Stav transpozice NIS2, rozsah a povinnosti podle polského zákona KSC.', sections: [{ h2: 'Agenda', content: ['Rozsah NIS2: základní a důležité subjekty', 'Stav a harmonogram zákona KSC v Polsku', 'Sankce a odpovědnost vedení', 'Praktická roadmapa shody'] }], internalLinks: [{ text: 'Standard NIS2', href: '/frameworks/nis-2' }, { text: 'Kybernetická prověrka', href: '/zkontrolujte-kybernetickou-bezpecnost' }, { text: 'Všechny akce', href: '/events' }] }
    },
    'event-nis2-risk-map': {
      en: { title: 'NIS2 Risk Map – Workshop | Quantifier', description: 'Hands-on workshop on building an NIS2 risk map: assets, threats, controls and residual risk scoring.', h1: 'NIS2 Risk Map — workshop', subtitle: 'Build an audit-ready NIS2 risk register and heatmap step by step.', sections: [{ h2: 'What you will learn', content: ['Asset inventory aligned to NIS2 Article 21', 'Threat modeling and impact assessment', 'Control mapping (ISO 27001 / NIST CSF)', 'Risk heatmap and remediation plan'] }], internalLinks: [{ text: 'NIS2 framework', href: '/frameworks/nis-2' }, { text: 'Risk Assessment', href: '/product/risk-assessment' }, { text: 'All events', href: '/events' }] },
      pl: { title: 'Mapa ryzyka NIS2 – Warsztat | Quantifier', description: 'Praktyczny warsztat budowy mapy ryzyka NIS2: aktywa, zagrożenia, kontrole i ocena ryzyka rezydualnego.', h1: 'Mapa ryzyka NIS2 — warsztat', subtitle: 'Zbuduj rejestr ryzyka i heatmapę NIS2 gotową do audytu krok po kroku.', sections: [{ h2: 'Czego się nauczysz', content: ['Inwentaryzacja aktywów wg art. 21 NIS2', 'Modelowanie zagrożeń i ocena wpływu', 'Mapowanie kontroli (ISO 27001 / NIST CSF)', 'Heatmapa ryzyka i plan działań'] }], internalLinks: [{ text: 'Standard NIS2', href: '/frameworks/nis-2' }, { text: 'Ocena ryzyka', href: '/product/risk-assessment' }, { text: 'Wszystkie wydarzenia', href: '/events' }] },
      cs: { title: 'Mapa rizik NIS2 – Workshop | Quantifier', description: 'Praktický workshop tvorby mapy rizik NIS2: aktiva, hrozby, kontroly a hodnocení zbytkového rizika.', h1: 'Mapa rizik NIS2 — workshop', subtitle: 'Postavte registr rizik a heatmapu NIS2 připravenou na audit krok za krokem.', sections: [{ h2: 'Co se naučíte', content: ['Inventarizace aktiv podle čl. 21 NIS2', 'Modelování hrozeb a hodnocení dopadu', 'Mapování kontrol (ISO 27001 / NIST CSF)', 'Heatmapa rizik a plán nápravy'] }], internalLinks: [{ text: 'Standard NIS2', href: '/frameworks/nis-2' }, { text: 'Hodnocení rizik', href: '/product/risk-assessment' }, { text: 'Všechny akce', href: '/events' }] }
    },
    'compare-vanta': {
      en: { title: 'Quantifier vs Vanta – GRC Platform Comparison', description: 'Compare Quantifier and Vanta across SOC 2, ISO 27001, NIS2 coverage, AI automation, EU data residency and pricing.', h1: 'Quantifier vs Vanta', subtitle: 'A factual comparison of GRC platforms for compliance teams.', sections: [{ h2: 'Key differences', content: ['Native NIS2 and EU regulation coverage', 'AI Compliance Officer for evidence collection', 'EU data residency and Polish/Czech localization', 'Product-level (LCA / EPD / DPP) modules', 'Transparent pricing for SMB and mid-market'] }], internalLinks: [{ text: 'GRC Platform', href: '/grc-platform' }, { text: 'SOC 2 automation', href: '/frameworks/soc' }, { text: 'Plans', href: '/plans' }] },
      pl: { title: 'Quantifier vs Vanta – Porównanie platform GRC', description: 'Porównaj Quantifier i Vanta: SOC 2, ISO 27001, NIS2, automatyzacja AI, dane w UE i cennik.', h1: 'Quantifier vs Vanta', subtitle: 'Rzetelne porównanie platform GRC dla zespołów compliance.', sections: [{ h2: 'Kluczowe różnice', content: ['Natywne wsparcie NIS2 i regulacji UE', 'AI Compliance Officer do zbierania dowodów', 'Dane w UE oraz lokalizacja PL/CS', 'Moduły produktowe (LCA / EPD / DPP)', 'Przejrzysty cennik dla SMB i mid-market'] }], internalLinks: [{ text: 'Platforma GRC', href: '/grc-platform' }, { text: 'Automatyzacja SOC 2', href: '/frameworks/soc' }, { text: 'Cennik', href: '/plans' }] },
      cs: { title: 'Quantifier vs Vanta – Srovnání GRC platforem', description: 'Srovnejte Quantifier a Vanta: SOC 2, ISO 27001, NIS2, automatizace AI, data v EU a ceny.', h1: 'Quantifier vs Vanta', subtitle: 'Věcné srovnání GRC platforem pro compliance týmy.', sections: [{ h2: 'Klíčové rozdíly', content: ['Nativní podpora NIS2 a regulací EU', 'AI Compliance Officer pro sběr důkazů', 'Data v EU a lokalizace PL/CS', 'Produktové moduly (LCA / EPD / DPP)', 'Transparentní ceny pro SMB a mid-market'] }], internalLinks: [{ text: 'GRC platforma', href: '/grc-platform' }, { text: 'Automatizace SOC 2', href: '/frameworks/soc' }, { text: 'Ceník', href: '/plans' }] }
    },
    'compare-drata': {
      en: { title: 'Quantifier vs Drata – GRC Platform Comparison', description: 'Compare Quantifier and Drata: SOC 2, ISO 27001, NIS2 coverage, AI automation, EU data residency and pricing.', h1: 'Quantifier vs Drata', subtitle: 'A factual comparison of GRC platforms for compliance teams.', sections: [{ h2: 'Key differences', content: ['Native NIS2 and EU regulation coverage', 'AI Compliance Officer for evidence collection', 'EU data residency and Polish/Czech localization', 'Product-level (LCA / EPD / DPP) modules', 'Transparent pricing for SMB and mid-market'] }], internalLinks: [{ text: 'GRC Platform', href: '/grc-platform' }, { text: 'SOC 2 automation', href: '/frameworks/soc' }, { text: 'Plans', href: '/plans' }] },
      pl: { title: 'Quantifier vs Drata – Porównanie platform GRC', description: 'Porównaj Quantifier i Drata: SOC 2, ISO 27001, NIS2, automatyzacja AI, dane w UE i cennik.', h1: 'Quantifier vs Drata', subtitle: 'Rzetelne porównanie platform GRC dla zespołów compliance.', sections: [{ h2: 'Kluczowe różnice', content: ['Natywne wsparcie NIS2 i regulacji UE', 'AI Compliance Officer do zbierania dowodów', 'Dane w UE oraz lokalizacja PL/CS', 'Moduły produktowe (LCA / EPD / DPP)', 'Przejrzysty cennik dla SMB i mid-market'] }], internalLinks: [{ text: 'Platforma GRC', href: '/grc-platform' }, { text: 'Automatyzacja SOC 2', href: '/frameworks/soc' }, { text: 'Cennik', href: '/plans' }] },
      cs: { title: 'Quantifier vs Drata – Srovnání GRC platforem', description: 'Srovnejte Quantifier a Drata: SOC 2, ISO 27001, NIS2, automatizace AI, data v EU a ceny.', h1: 'Quantifier vs Drata', subtitle: 'Věcné srovnání GRC platforem pro compliance týmy.', sections: [{ h2: 'Klíčové rozdíly', content: ['Nativní podpora NIS2 a regulací EU', 'AI Compliance Officer pro sběr důkazů', 'Data v EU a lokalizace PL/CS', 'Produktové moduly (LCA / EPD / DPP)', 'Transparentní ceny pro SMB a mid-market'] }], internalLinks: [{ text: 'GRC platforma', href: '/grc-platform' }, { text: 'Automatizace SOC 2', href: '/frameworks/soc' }, { text: 'Ceník', href: '/plans' }] }
    },
    'compare-sprinto': {
      en: { title: 'Quantifier vs Sprinto – GRC Platform Comparison', description: 'Compare Quantifier and Sprinto: SOC 2, ISO 27001, NIS2 coverage, AI automation, EU data residency and pricing.', h1: 'Quantifier vs Sprinto', subtitle: 'A factual comparison of GRC platforms for compliance teams.', sections: [{ h2: 'Key differences', content: ['Native NIS2 and EU regulation coverage', 'AI Compliance Officer for evidence collection', 'EU data residency and Polish/Czech localization', 'Product-level (LCA / EPD / DPP) modules', 'Transparent pricing for SMB and mid-market'] }], internalLinks: [{ text: 'GRC Platform', href: '/grc-platform' }, { text: 'SOC 2 automation', href: '/frameworks/soc' }, { text: 'Plans', href: '/plans' }] },
      pl: { title: 'Quantifier vs Sprinto – Porównanie platform GRC', description: 'Porównaj Quantifier i Sprinto: SOC 2, ISO 27001, NIS2, automatyzacja AI, dane w UE i cennik.', h1: 'Quantifier vs Sprinto', subtitle: 'Rzetelne porównanie platform GRC dla zespołów compliance.', sections: [{ h2: 'Kluczowe różnice', content: ['Natywne wsparcie NIS2 i regulacji UE', 'AI Compliance Officer do zbierania dowodów', 'Dane w UE oraz lokalizacja PL/CS', 'Moduły produktowe (LCA / EPD / DPP)', 'Przejrzysty cennik dla SMB i mid-market'] }], internalLinks: [{ text: 'Platforma GRC', href: '/grc-platform' }, { text: 'Automatyzacja SOC 2', href: '/frameworks/soc' }, { text: 'Cennik', href: '/plans' }] },
      cs: { title: 'Quantifier vs Sprinto – Srovnání GRC platforem', description: 'Srovnejte Quantifier a Sprinto: SOC 2, ISO 27001, NIS2, automatizace AI, data v EU a ceny.', h1: 'Quantifier vs Sprinto', subtitle: 'Věcné srovnání GRC platforem pro compliance týmy.', sections: [{ h2: 'Klíčové rozdíly', content: ['Nativní podpora NIS2 a regulací EU', 'AI Compliance Officer pro sběr důkazů', 'Data v EU a lokalizace PL/CS', 'Produktové moduly (LCA / EPD / DPP)', 'Transparentní ceny pro SMB a mid-market'] }], internalLinks: [{ text: 'GRC platforma', href: '/grc-platform' }, { text: 'Automatizace SOC 2', href: '/frameworks/soc' }, { text: 'Ceník', href: '/plans' }] }
    }
  };
