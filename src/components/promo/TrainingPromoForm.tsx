...
const messageTag = (locale: Locale): string => {
  switch (locale) {
    case 'pl':
      return '[Promo 31.07.2026 — 1h szkolenie / NIS2 / KSC / ISO 27001]';
    case 'en':
      return '[Promo 31 July 2026 — 1h training / NIS2 / ISO 27001]';
    case 'cs':
      return '[Promo 14. 7. 2026 — 4h školení / NIS2 / ISO 27001]';
  }
};
...
const FormCard = ({
  ...
  return (
    <div
      id={id}
      className="bg-slate-900/70 backdrop-blur-md border border-white/10 rounded-2xl p-6 md:p-8 shadow-2xl"
    >
      {sent ? (
...
export const TrainingPromoFormInline = FormCard;
