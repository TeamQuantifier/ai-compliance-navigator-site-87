...
const EventAudienceCards = ({ audience }: Props) => {
  ...
  return (
    <section className="py-10 md:py-14">
      <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-8">{t('eventDetail.audienceTitle')}</h2>
        ...
        {audience.map((card, i) => {
          ...
          return (
            <div key={i} className="bg-card border border-border rounded-xl p-6">
              ...
              <div className="mb-4">
                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">{t('eventDetail.challengesLabel')}</p>
              ...
              <div>
                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-2">{t('eventDetail.outcomesLabel')}</p>
                <ul className="space-y-1.5">
