        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-14">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 mb-5">
              ...
              <span className="text-xs font-semibold tracking-wide text-primary uppercase">Konfigurator programu</span>
            </div>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg border text-sm transition-all ${
                      selectedArea === area
                        ...
                        : 'border-white/10 hover:border-white/30 bg-white/5 text-slate-300'
                    }`}
                  >
                    {area === 'cybersecurity' && <ShieldAlert className="h-4 w-4 text-blue-400" />}
                    {area === 'esg' && <Leaf className="h-4 w-4 text-emerald-400" />}
                    {area === 'compliance' && <Scale className="h-4 w-4 text-violet-400" />}
                    {t(`training.form.areas.${area}.title`)}
                  </button>
                ))}
              </div>
