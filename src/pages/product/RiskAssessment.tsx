  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        {/* 6. FAQ */}
        <FAQSection
          title={t('product.riskAssessment.faq.title')}
          faqs={faqKeys.map((key) => ({
            question: t(`product.riskAssessment.faq.${key}.question`),
            answer: t(`product.riskAssessment.faq.${key}.answer`),
          }))}
          pageUrl={`https://quantifier.ai/${currentLocale}/product/risk-assessment`}
        />
