...
export const events: EventData[] = [
  {
    ...
    dateDisplay: '17 marca 2026, godz. 10:00',
    duration: '30 minut',
  ...
  },
  {
    ...
    dateDisplay: '31 marca 2026, godz. 10:00',
    duration: '30 minut',
    location: 'Online (na żywo)',
    tags: ['Live', 'NIS2 & ISO 27001'],
    heroCtaLabel: 'Zarezerwuj miejsce',
  ...
  },
  {
    ...
    dateDisplay: '21 kwietnia 2026, godz. 10:00',
    duration: '30 minut',
    location: 'Online (na żywo)',
    tags: ['Live', 'NIS2 & ISO 27001'],
    heroCtaLabel: 'Zarezerwuj miejsce',
    heroSecondaryText: 'Bezpłatny webinar online',
    trustLine: 'Dowiedz się, jak przygotować dokumenty i dowody zgodności na kontrolę.',
    icon: 'FileCheck',
    step: 3,
    outcomes: [
  ...
  },
  {
    ...
    dateDisplay: '5 maja 2026, godz. 10:00',
    duration: '30 minut',
    location: 'Online (na żywo)',
    tags: ['Live', 'NIS2 & ISO 27001'],
    heroCtaLabel: 'Zarezerwuj miejsce',
